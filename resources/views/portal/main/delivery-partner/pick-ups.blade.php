...
@section('page-title')Pick Ups @endsection
...
@section('content-body')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" style="text-align: right; margin-bottom:10px;">
                        @if(sizeof($pick_up_items) > 0)
                            <form method="POST" action="{{ route('delivery-partner.process.pick.ups') }}">
                                @csrf
    ...
    <form id="item-picked-up-form" method="POST" action="{{ route('delivery-partner.process.pick.ups') }}">
        @csrf
