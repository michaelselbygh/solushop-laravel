                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name='type' id="type" style='border-radius:7px;' required>
                                                <option value='0' @if($product["product_dc"] == 0) selected="selected" @endif>Available In Stock</option>
                                                <option value='1' @if($product["product_dc"] == 1) selected="selected" @endif>Available On Pre-Order</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
