                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name='vendor' id="vendor" style='border-radius:7px;' required>
                                                @for ($i = 0; $i < sizeof($product["vendor_options"]); $i++)
                                                    <option value="{{ $product["vendor_options"][$i]["id"] }}">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="dd" name="dd" class="form-control round" placeholder="Enter product delivery duration" value="1" type="number" step="1" min="1" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="dc">Delivery Charge in GHS </label>
                                            <input id="dc" name="dc" class="form-control round" placeholder="Enter product delivery charge" value="1" type="number" step="1" min="1" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
