...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <body class="vertical-layout vertical-menu 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu" data-col="2-columns">
                        ...
                        <ul class="nav navbar-nav float-right">
                            <li class=" dropdown-user nav-item">
                                <a class=" nav-link dropdown-user-link">
                                    <span class="mr-1 user-name text-bold-700">{{ Auth::guard('delivery-partner')->user()->first_name." ".Auth::guard('delivery-partner')->user()->last_name }}</span>
        ...
        <!-- BEGIN: Main Menu-->
        @include('portal.main.delivery-partner.sidebar')
        <!-- END: Main Menu-->
