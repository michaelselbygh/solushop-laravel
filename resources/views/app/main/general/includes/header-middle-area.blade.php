    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2 col-sm-3 col-xs-12">
                <div class="logo">
                    <a href="index.php"><img src="{{ url('app/assets/img/logo/logo.png') }}" alt="Solushop Logo" style="width: 130px;
                        height: auto;"></a>
                </div>
            </div>
            <!--Logo End-->
                           ...
                           <select name='search_category' data-placeholder="Choose Category" class="select" tabindex="1" required>
                               <option value='All'>Select Category</option>
                                @foreach ($productCategories as $productCategory)
                                    <option value='{{ $productCategory->pc_id }}'>{{ $productCategory->pc_description }}</option>
                                @endforeach
                           </select>
                        </div>
                        <div class="search-box">
                            <input type="text" name="search_value" id="search" placeholder="" value=''>
